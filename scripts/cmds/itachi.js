...
module.exports.onChat = async function({
  ...
  if (event.body && ["itachi", "Itachi", "it", "uchiha"].includes(event.body.toLowerCase())) {
    const greetings = [
      "🅝🅔🅩🅤🅚🅞 বলে অসম্মান করচ্ছিছ,😰😿",
      "দূরে যা, তোর কোনো কাজ নাই, শুধু 🅝🅔🅩🅤🅚🅞 🅝🅔🅩🅤🅚🅞 করিস  😉😋🤣",
      "𝗛𝗲𝘆 𝗯𝗯𝘆 𝗜 𝗮𝗺 𝗵𝗲𝗿𝗲🌟",
      ...
      "𝗛𝗲𝘆 𝗯𝗯𝘆 𝗶 𝗮𝗺 🅝🅔🅩🅤🅚🅞 𝗳𝗿𝗼𝗺 𝗛4𝗦𝗦𝗔1𝗡 𝘀𝗮𝗿𝘃𝗲𝗿🇧🇩🤖",
      "🅝🅔🅩🅤🅚🅞 বললে চাকরি থাকবে না____😰😰☠",
      "এত 🅝🅔🅩🅤🅚🅞 🅝🅔🅩🅤🅚🅞 করস কেন কি হইছে বল___😾😾🔪🔪",
      "দূরে গিয়ে মর এত 🅝🅔🅩🅤🅚🅞 🅝🅔🅩🅤🅚🅞 না করে___😾😾🔪🔪"
    ];
